...
<div style="background:#eef2ff;border-left:5px solid #6366f1;padding:18px;border-radius:8px;margin-bottom:24px;">
    ...
    Application <strong>#{{ $applicationId }}</strong> is awaiting your review in the approval pipeline.
</div>

<p>Dear Reviewer,</p>
<p>A new application has been submitted and requires your attention.</p>

<div style="background:#f8fafc;border:1px solid #e5e7eb;padding:20px;border-radius:10px;margin:24px 0;">
    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" style="font-size:15px;">
        <tr>
            <td style="padding-bottom:8px;color:#64748b;" width="120">Applicant:</td>
            <td style="padding-bottom:8px;font-weight:600;">{{ $applicantName }}</td>
        </tr>
        <tr>
