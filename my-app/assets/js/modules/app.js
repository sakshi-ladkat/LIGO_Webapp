...
const routes = [
  ...
  },
  {
    ...
    onMount: async () => {
      ...
      if (module && typeof module.mountLogin === 'function') {
        module.mountLogin();
      }
    }
  },
  ...
  {
    path: '/dashboard',
    view: () => loadPage('dashboard'),
    onMount: async () => {
      const module = await import('./dashboard.js');
      if (module && typeof module.mountDashboard === 'function') {
        module.mountDashboard();
      }
    }
  },
  {
