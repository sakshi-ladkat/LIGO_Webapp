            ...
            <div style="background: ${String(p.duplicate_warnings.risk_score?.risk || '').toUpperCase() === 'HIGH' ? '#fef2f2' : '#fffbeb'}; border: 1px solid ${String(p.duplicate_warnings.risk_score?.risk || '').toUpperCase() === 'HIGH' ? '#fecaca' : '#fde68a'}; border-radius: 0.5rem; padding: 1rem; margin-top: 1rem; margin-bottom: 1rem;">
                <div style="display: flex; align-items: flex-start; gap: 0.75rem;">
                    <div style="background: ${String(p.duplicate_warnings.risk_score?.risk || '').toUpperCase() === 'HIGH' ? '#ef4444' : '#f59e0b'}; color: white; padding: 4px; border-radius: 4px; flex-shrink: 0;">
                        <span class="extracted-svg" style="-webkit-mask: url(/public/assets/icons/ic_ui_element_49.svg) no-repeat center; mask: url(/public/assets/icons/ic_ui_element_49.svg) no-repeat center; -webkit-mask-size: contain; mask-size: contain; background-color: currentColor; width: 18px; height: 18px; display: inline-block;"></span>
                    </div>
                    <div style="flex-grow: 1;">
                        ...
                        <button
                            ...
                            <span class="extracted-svg" style="-webkit-mask: url(/public/assets/icons/ic_ui_element_50.svg) no-repeat center; mask: url(/public/assets/icons/ic_ui_element_50.svg) no-repeat center; -webkit-mask-size: contain; mask-size: contain; background-color: currentColor; width: 14px; height: 14px; display: inline-block;"></span>
                            Compare Identity
                        </button>
                    </div>
                </div>
            ...
            <div style="margin-top: 1.5rem;">
                ${app.id_card_approved_by ? `
                    <div style="background: #ecfdf5; border: 1px solid #a7f3d0; border-radius: 0.5rem; padding: 0.75rem; margin-bottom: 0.75rem; font-size: 0.8rem; color: #065f46; display: flex; align-items: flex-start; gap: 0.6rem;">
                        <span class="extracted-svg" style="-webkit-mask: url(/public/assets/icons/ic_ui_element_51.svg) no-repeat center; mask: url(/public/assets/icons/ic_ui_element_51.svg) no-repeat center; -webkit-mask-size: contain; mask-size: contain; background-color: currentColor; width: 18px; height: 18px; display: inline-block; margin-top: 2px; flex-shrink: 0;"></span>
                        <div>
                ...
                <button class="rm-identity-btn" id="rm-identity-btn" style="width: 100%; background: ${app.id_card_approved_by ? '#10b981' : 'var(--primary-600)'}; color: white; border: none; box-shadow: var(--shadow-sm); transition: background 0.2s;">
                    <span class="extracted-svg" style="-webkit-mask: url(/public/assets/icons/ic_ui_element_52.svg) no-repeat center; mask: url(/public/assets/icons/ic_ui_element_52.svg) no-repeat center; -webkit-mask-size: contain; mask-size: contain; background-color: currentColor; width: 18px; height: 18px; display: inline-block; margin-right:8px;"></span>
