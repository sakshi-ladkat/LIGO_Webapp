        ...
        <div>
            ...
            <div style="display:flex;flex-direction:column;gap:1.5rem;">
                <div class="db-tracker-card" style="padding:2rem 2.5rem;box-shadow:0 4px 20px rgba(0,0,0,0.05);">
                    <div class="profile-section-header" style="margin-bottom:1.5rem;"><h3 class="profile-section-title" style="font-size:1.25rem;font-weight:800;color:#0f172a;"><span class="extracted-svg" style="display: inline-block; width: 18px; height: 18px; -webkit-mask-image: url(/public/assets/icons/user.svg); mask-image: url(/public/assets/icons/user.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor;"></span> Personal Information</h3></div>
                    ${buildPersonalPanel(p)}
                </div>

                <div class="db-tracker-card" style="padding:2rem 2.5rem;box-shadow:0 4px 20px rgba(0,0,0,0.05);">
                    <div class="profile-section-header" style="margin-bottom:1.5rem;"><h3 class="profile-section-title" style="font-size:1.25rem;font-weight:800;color:#0f172a;"><span class="extracted-svg" style="display: inline-block; width: 18px; height: 18px; -webkit-mask-image: url(/public/assets/icons/book-open.svg); mask-image: url(/public/assets/icons/book-open.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor;"></span> Qualification &amp; History</h3></div>
                    ${buildQualPanel(quals)}
                </div>

                <div class="db-tracker-card" style="padding:2rem 2.5rem;box-shadow:0 4px 20px rgba(0,0,0,0.05);">
                    <div class="profile-section-header" style="margin-bottom:1.5rem;"><h3 class="profile-section-title" style="font-size:1.25rem;font-weight:800;color:#0f172a;"><span class="extracted-svg" style="display: inline-block; width: 18px; height: 18px; -webkit-mask-image: url(/public/assets/icons/phone.svg); mask-image: url(/public/assets/icons/phone.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor;"></span> Contact Details</h3></div>
    ...
    return `
        <div>
            <div class="sb-header-action" style="padding-bottom:1rem;border-bottom:1px solid #f1f5f9;margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;">
                ...
                <button type="button" class="sb-btn-edit" style="background:#6366f1;color:white;border:none;padding:0.5rem 1rem;border-radius:0.5rem;font-weight:600;display:flex;align-items:center;gap:0.5rem;transition:all 0.2s;box-shadow:0 2px 8px rgba(99,102,241,0.25);"><span class="extracted-svg" style="width:14px;height:14px; display: inline-block; -webkit-mask-image: url(/public/assets/icons/edit-2.svg); mask-image: url(/public/assets/icons/edit-2.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor;"></span> Edit Info</button>
            </div>
        ...
        const rows = quals.map(q => {
            ...
            <tr style="border-bottom:1px solid #f1f5f9;">
                ...
                <td style="padding:1.25rem 1rem;">
                    ...
                    <div style="font-size:0.8rem;color:#94a3b8;margin-top:0.25rem;display:flex;align-items:center;gap:0.3rem;"><span class="extracted-svg" style="width:12px;height:12px; display: inline-block; -webkit-mask-image: url(/public/assets/icons/calendar.svg); mask-image: url(/public/assets/icons/calendar.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor;"></span> Class of ${__esc(q.graduation_month || '—')}/${__esc(q.graduation_year || '—')}</div>
                </td>
                <td style="padding:1.25rem 1rem;">
                    ${isActive ? '<span style="background:#6366f1;color:white;padding:0.3rem 0.8rem;border-radius:99px;font-size:0.65rem;font-weight:800;text-transform:uppercase;box-shadow:0 2px 6px rgba(99,102,241,0.2);">Active</span>' : '<span style="color:#94a3b8;font-size:0.75rem;font-weight:600;display:flex;align-items:center;gap:0.3rem;"><span class="extracted-svg" style="width:12px;height:12px; display: inline-block; -webkit-mask-image: url(/public/assets/icons/check-circle.svg); mask-image: url(/public/assets/icons/check-circle.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor;"></span> Completed</span>'}
                </td>
            </tr>`;
        }).join('');
    ...
    return `
        <div>
            <div class="sb-header-action" style="padding-bottom:1rem;border-bottom:1px solid #f1f5f9;margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;">
                ...
                <button type="button" class="sb-btn-edit" style="background:#6366f1;color:white;border:none;padding:0.5rem 1rem;border-radius:0.5rem;font-weight:600;display:flex;align-items:center;gap:0.5rem;transition:all 0.2s;box-shadow:0 2px 8px rgba(99,102,241,0.25);"><span class="extracted-svg" style="width:14px;height:14px; display: inline-block; -webkit-mask-image: url(/public/assets/icons/plus.svg); mask-image: url(/public/assets/icons/plus.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor;"></span> Add New</button>
            </div>
...
export function buildContactPanel(c) {
    ...
    return `
        <div>
            <div class="sb-header-action" style="padding-bottom:1rem;border-bottom:1px solid #f1f5f9;margin-bottom:1.5rem;display:flex;justify-content:space-between;align-items:center;">
                <span class="sb-panel-title" style="font-weight:700;color:#64748b;text-transform:uppercase;font-size:0.75rem;letter-spacing:0.05em;">Current Details</span>
                <button type="button" class="sb-btn-edit" style="background:#6366f1;color:white;border:none;padding:0.5rem 1rem;border-radius:0.5rem;font-weight:600;display:flex;align-items:center;gap:0.5rem;transition:all 0.2s;box-shadow:0 2px 8px rgba(99,102,241,0.25);"><span class="extracted-svg" style="width:14px;height:14px; display: inline-block; -webkit-mask-image: url(/public/assets/icons/edit-2.svg); mask-image: url(/public/assets/icons/edit-2.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor;"></span> Edit Details</button>
            </div>
            <div class="sb-view-mode" style="display:grid;grid-template-columns:repeat(auto-fit, minmax(200px, 1fr));gap:1.5rem;">
