    ...
    container.innerHTML = `
        <div class="adm-page-header" style="margin-bottom:2rem; display:flex; align-items:center; gap:1.5rem;">
            <button class="adm-btn adm-btn-secondary" onclick="_switchTab('modify')" style="padding:0.5rem; border-radius:50%; width:40px; height:40px;">
                <span class="extracted-svg" style="-webkit-mask-image: url(/public/assets/icons/arrow-left.svg); mask-image: url(/public/assets/icons/arrow-left.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor; width: 18px; height: 18px; display: inline-block;"></span>
            </button>
            <div>
                <h2 class="adm-page-title"><span class="extracted-svg" style="-webkit-mask: url(/public/assets/icons/ic_ui_element_35.svg) no-repeat center; mask: url(/public/assets/icons/ic_ui_element_35.svg) no-repeat center; -webkit-mask-size: contain; mask-size: contain; background-color: currentColor; width: 24px; height: 24px; display: inline-block; vertical-align: middle; margin-right: 8px;"></span>Modify Institutes</h2>
                                    ...
                                    <td style="text-align:center; white-space:nowrap;">
                                        <div style="display:flex; align-items:center; justify-content:center; gap:8px;">
                                            <button class="adm-inst-edit-btn"
                                                ...
                                                <span class="extracted-svg" style="width:12px; height:12px; display: inline-block; -webkit-mask-image: url(/public/assets/icons/edit-3.svg); mask-image: url(/public/assets/icons/edit-3.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor;"></span> Modify
                                            </button>
                                            ...
                                            <button class="adm-inst-remove-btn"
                                                ...
                                                <span class="extracted-svg" style="width:12px; height:12px; display: inline-block; -webkit-mask-image: url(/public/assets/icons/trash-2.svg); mask-image: url(/public/assets/icons/trash-2.svg); -webkit-mask-size: contain; mask-size: contain; -webkit-mask-repeat: no-repeat; mask-repeat: no-repeat; -webkit-mask-position: center; mask-position: center; background-color: currentColor;"></span> Remove
                                            </button>
                                        </div>
                                    </td>
